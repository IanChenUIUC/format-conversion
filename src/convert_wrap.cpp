...
PYBIND11_MODULE(_core, m)
{
    ...
    m.def(
        ...
        [](const std::filesystem::path &nodes_file, const std::filesystem::path &edges_file,
           const std::filesystem::path &metis_file, const ConvertOptions &opts) {
            convert_graph(nodes_file.string(), edges_file.string(), metis_file.string(), opts);
        },
        py::arg("nodes_file"), py::arg("edges_file"), py::arg("metis_file"), py::arg("opts") = ConvertOptions{},
